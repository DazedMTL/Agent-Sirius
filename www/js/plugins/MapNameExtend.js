...
(function () {
  ...
  param.useControlCharacter = getParamBoolean([
    "UseControlCharacter",
    "制御文字使用",
  ]);
  ...
  Game_Map.prototype.displayName = function () {
    ...
    if (index > 1 && $dataMap.meta) {
      ...
      return (
        _Game_Map_displayName.apply(this, arguments) || this.getRealMapName()
      );
    }
  };

  Game_Map.prototype.getRealMapName = function () {
    return param.showRealName && $dataMapInfos[this._mapId]
      ? $dataMapInfos[this._mapId].name
      : "";
  };
  ...
  Window_MapName.prototype.createBackground = function () {
    ...
    this._backSprite.bitmap.addLoadListener(
      function () {
        this._backSprite.x =
          this.windowWidth() / 2 - this._backSprite.width / 2;
        this._backSprite.y =
          this.windowHeight() / 2 - this._backSprite.height / 2;
      }.bind(this)
    );
  ...
  Window_MapName.prototype.windowWidth = function () {
    return param.width
      ? param.width
      : _Window_MapName_windowWidth.apply(this, arguments);
  };
